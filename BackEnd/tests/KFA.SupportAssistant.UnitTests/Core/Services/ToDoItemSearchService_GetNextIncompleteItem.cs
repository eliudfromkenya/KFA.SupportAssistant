...
using KFA.SupportAssistant.Core.ProjectAggregate;
using KFA.SupportAssistant.Core.Services;
using KFA.SupportAssistant.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace KFA.SupportAssistant.UnitTests.Core.Services
{
