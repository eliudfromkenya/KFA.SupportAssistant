...
public class List(IMediator mediator, IEndPointManager endPointManager) : Endpoint<ListParam, UserAuditTrailListResponse>
{
  ...
  public override void Configure()
  {
    ...
    Summary(s =>
    {
      ...
      s.ResponseExamples[200] = new UserAuditTrailListResponse { UserAuditTrails = [new UserAuditTrailRecord(DateTime.Now, 0, "1000", "Category", string.Empty, "Data", "Description", string.Empty, "Narration", "Old Values", DateTime.Now, DateTime.Now)] };
