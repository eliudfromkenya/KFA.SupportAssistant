...
public class List(IMediator mediator, IEndPointManager endPointManager) : Endpoint<ListParam, UserLoginListResponse>
{
  ...
  public override void Configure()
  {
    ...
    Summary(s =>
    {
      ...
      s.ResponseExamples[200] = new UserLoginListResponse { UserLogins = [new UserLoginRecord(string.Empty, DateTime.Now, "1000", "Narration", DateTime.Now, string.Empty, DateTime.Now, DateTime.Now)] };
