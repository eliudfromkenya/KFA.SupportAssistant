...
/// </summary>
public class UpdateComputerAssetsMaintainceAccessoryValidator : Validator<UpdateComputerAssetsMaintainceAccessoryRequest>
{
  public UpdateComputerAssetsMaintainceAccessoryValidator()
  {
    ...
    RuleFor(x => x.AccessoryID)
      .Must((args, id) => checkIds(args.AccessoryID, id))
