...
public class List(IMediator mediator, IEndPointManager endPointManager) : Endpoint<ListParam, IssuesProgressListResponse>
{
  ...
  public override void Configure()
  {
    ...
    Summary(s =>
    {
      ...
      s.ResponseExamples[200] = new IssuesProgressListResponse { IssuesProgresses = [new IssuesProgressRecord("Description", string.Empty, "Narration", "1000", "Reported By", Core.Models.Types.IssueStatus.None, DateTime.Now, DateTime.Now, DateTime.Now)] };
